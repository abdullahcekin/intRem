  ...
  return <div className="info-page">
    ...
    <main id="info-content" className="info-content" tabIndex={-1}>
      ...
      <section id="yardim" className="info-section info-faq" aria-labelledby="help-title">
        ...
        <details><summary>Sistemdeki OmniRoute bilgileri ne anlama geliyor?</summary><p>“Erişilebilir” yalnız gateway bağlantısının yanıt verdiğini gösterir. Kurulum bölümündeki hesap bağlantısı ve model havuzu sayıları kayıtlı yapılandırmayı gösterir. “0” doğrulanmış boş kayıt demektir; “Bilinmiyor” veya “Yetki gerekiyor” görünüyorsa sayı okunamamıştır. Sunucu yöneticisi salt okunur erişimi kontrol etmelidir. Son kontrol zamanını dikkate alın; kayıt sayıları kullanılabilir kota, doğru yönlendirme veya bir istekte gerçekten kullanılan hesabın kanıtı değildir.</p></details>
        ...
        <details><summary>Mobil uyumluluk neyi kapsıyor?</summary><p>Arayüz küçük telefonlardan masaüstüne uyarlanır; dokunma hedefleri, kaydırma alanları ve alt gezinme mobil kullanım için düzenlenmiştir. Fiziksel cihazda klavye, passkey, PWA ve bildirim deneyimi ayrıca doğrulanmalıdır. Tarayıcıdaki ekran ölçüsü testleri bu kabulün yerini tutmaz.</p></details>
      </section>
