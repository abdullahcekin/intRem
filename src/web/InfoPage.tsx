    ...
    <main id="info-content" className="info-content" tabIndex={-1}>
      ...
      <section id="kullanim" className="info-section" aria-labelledby="usage-title">
        ...
        <ol className="info-steps">
          ...
          <li><h3>Bir oturum seçin veya başlatın</h3><p>Konuşmayı açın ve mesajınızı gönderin. Göndermeden önce seçili proje ve oturum adını kontrol edin. Mevcut oturumu bağlamak kaynak geçmişini izler. Kaynak terminalin yeni çoktan seçmeli soruları için konuşmanın altından “Canlı sorular → Canlı soruları bağla” seçin. Bağlantıdan gelen yeni soruyu “Bekleyenler” veya “İncele” üzerinden yanıtlayabilirsiniz. Önceden açılmış sorular ve araç izinleri kaynak terminalde kalır. Kaynak süreç çıktıktan sonra kontrollü devirle aynı konuşmaya devam edebilirsiniz.</p></li>
