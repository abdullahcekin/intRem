...
- **2026-09-14 oturum okunabilirliği düzeltmesi, yerel doğrulama:** masaüstünde iki panel ayrı gizlenebilir; odak modunda yalnız konuşma ve çıkış/yazma kontrolleri kalır. Mobilde seçili oturum genel üst/alt gezinmeyi kaldırır; teknik bilgiler pencereye taşınmıştır. 320×568 ve 375×667'de konuşma, textarea ve gönder düğmesi otomatik kaydırma olmadan doğrulandı; kısa viewport, uzun ad/metin, salt okunur kaynak, taslak ve modal klavye regresyonları dahil **28 Chromium kontrolü** geçti. Tip kontrolü, build ve Windows'ta **155 test + 2 Linux testi atlama** başarılı. Kaynak commit/CI/canlı dağıtım bu satırda henüz tamamlanmış sayılmaz; aşağıdaki önceki sürüm kanıtından ayrıdır.

- Kaynak sürümü **`41a0098d8a7b4141c53ebbd0fb540521b76555fe`**, `main` dalına yayınlandı ve normal API/runner servislerine dağıtıldı; kaynak tmux süreçleri korundu. Sonraki yalnız belge commit'leri için canlı Git/CI durumunu ayrıca kontrol edin.
