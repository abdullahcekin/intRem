...
- **Güncel kaynak `8ef85ecc70a91f1da529e7d5ab2a015e1d5d0e4e` yayınlandı ve canlıya dağıtıldı.** [CI başarılı](https://github.com/abdullahcekin/intRem/actions/runs/34854692041): tip kontrolü, 157 Linux testi, build, **28 Chromium kontrolü** ve **7 geri yükleme kontrolü / 13 tablo**. Windows'ta 155 test geçti, iki Linux testi atlandı. Statik arayüz dosyaları ayrı dizinde derlenip index en son yayınlandı; API/runner yeniden başlatılmadı, kaynak süreçler korundu. Dış HTTPS ana sayfa/health/info 200, girişsiz snapshot 401; dışarıdan alınan JS/CSS hash'leri yerel derlemeyle eşleşti.
